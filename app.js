...
const data = {
  prompt :
      `Your task is to write content for the home page of a website. The required content is delimited in backticks. For each requirement, provide the output in a structured manner. Later, also provide the same output in JSON format with keys :
